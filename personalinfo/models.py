...
class User(AbstractUser):
    ...
    bio = TranslatedField(
        models.TextField(blank=True, null=True),
         ...
         "en":{"verbose_name":" توضيحات مختصر درباره من در سايت انگليسي "},
         }
    )

    compeltebio = TranslatedField(
         models.TextField(blank=True, null=True),
         {"fa":{"verbose_name":" توضيحات جامع تر درباره من در سايت فارسي "},
         "en":{"verbose_name":" توضيحات جامع تر درباره من در سايت انگليسي "},
         }
    )
...
class Service(models.Model):
    ...
    title = TranslatedField(
         ...
         "en":{"verbose_name":" عنوان سرويس در سايت انگليسي "},
         }
    )
