...
class IndexView(generic.TemplateView):
	...
	def get_context_data(self, **kwargs):
		...
		context["count_projects"] = Portfolio.objects.count()		
		context["count_certificates"] = Certificate.objects.filter(is_active=True).count()	
		context["count_publications"] = Publication.objects.all().count()
